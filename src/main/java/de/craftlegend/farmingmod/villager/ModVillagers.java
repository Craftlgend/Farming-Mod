package de.craftlegend.farmingmod.villager;
...
public class ModVillagers {
    ...
    private static VillagerProfession registerProfession(String name, RegistryKey<PointOfInterestType> type) {
        return Registry.register(Registries.VILLAGER_PROFESSION, new Identifier(FarmingMod.MOD_ID, name), new VillagerProfession(name,
    ...
    private static PointOfInterestType registerPoi(String name, Block block) {
        return PointOfInterestHelper.register(new Identifier(FarmingMod.MOD_ID, name), 1, 1, block);
    }


    private static RegistryKey<PointOfInterestType> poiKey(String name) {
        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, new Identifier(FarmingMod.MOD_ID, name));
    }

    public static void registerVillager() {
        FarmingMod.LOGGER.info("Registering Villagers " + FarmingMod.MOD_ID);
    }
}
